...
5.  (4pts) What would be the optimal number of buckets to have with
    ...
    > The optimal number of buckets to have is 10.
...
> 
> Your implementation should NOT use an strategy that requires you to loop 
> through all of the elements of BOTH sets:
> ```c++
> // Not ok...
